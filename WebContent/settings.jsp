...
<head>
	...
	<link href="/chapter6/WebContent/css/style.css" rel="stylesheet" type="text/css">
...
<form action="settings" method="post" enctype="multipart/form-data"><br />
	...
	（あなたの公開プロフィール:http://localhost:8080/?account=アカウント名）<br /><br />
...
<div class="copyright">Copyright(c)tanimoto horoshi</div>
</div>
</body>
</html>
